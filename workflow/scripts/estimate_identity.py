...
if __name__ == "__main__":
    import sys
    from read_fasta import readKmersFromFile
    ...
    delta = 0.5
    modimizer = 1000
    for ctg, kmers in readKmersFromFile(fa, ksize=21):
        mtx = createSelfMatrix(
            kmers, window, delta, kmer_size, ident_thr, False, modimizer
        )
        for line in convertMatrixToBed(mtx, window, ident_thr, ctg, ctg, True):
